...
const SkillsCard = ({ item }) => {
    ...
    return (
        <div>
            ...
            <div className="grid lg:grid-cols-8 grid-cols-4 text-white mb-20">
                {
                    skillSet.map((skill, index) =>
                        <div key={index} className='my-4 flex flex-col items-center hover:text-[#03C988]' data-aos="fade-up" data-aos-delay={`${((index) % 6) * 100 + 100}`}>
                            <div className='h-20 w-[70px] flex items-center justify-center glowing-border border-2 border-white rounded-3xl'>
