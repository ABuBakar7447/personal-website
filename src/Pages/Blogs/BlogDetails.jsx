    ...
    <div>
      <div className="min-h-screen">
        ...
        <motion.section
          ...
          className="bg-gradient-to-r from-[#34525f] to-[#2c5364] text-white py-20 px-4 w-[85%] mx-auto"
        >
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    <span>{post.date}</span>
                    <button className="ml-auto px-4 py-2 btn btn-success text-white rounded-lg hover:bg-blue-700 transition-colors">
                      Read More
                    </button>
                  </div>
                </div>
